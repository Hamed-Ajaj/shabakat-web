...
export const createSubscriberSchema = z
  .object({
    ...
    building: z.string().trim().max(100, "Building must be 100 characters or fewer.").optional().or(z.literal("")),
    floor: z.string().trim().max(50, "Floor must be 50 characters or fewer.").optional().or(z.literal("")),
    ...
    customerStatus: z.enum(["Active", "Suspended", "Terminated"]),
